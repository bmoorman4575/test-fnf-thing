...
gdjs.evtsExt__PlaySound__Function.userFunc0x570cdb8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
try {
  ...
  console.log(runtimeScene.getVariables().get("timetemp").setNumber(currentTimeValue));
} catch (err) {
  console.log(err);
}
...
gdjs.evtsExt__PlaySound__Function.userFunc0x570cdb8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
