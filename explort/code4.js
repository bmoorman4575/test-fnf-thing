...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(69936620);
}
}
if (isConditionTrue_0) {
}
...
};gdjs.ModdingtoolsCode.asyncCallback69949412 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(5), (runtimeScene) => (gdjs.ModdingtoolsCode.asyncCallback69949412(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
{runtimeScene.getGame().getVariables().getFromIndex(12).getChild("scenetogoto").setString("modeedit.chatectededitor");
}{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Loadingscenes", false);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(69949260);
}
}
if (isConditionTrue_0) {
