...
gdjs.ModdingtoolsCode.mapOfGDgdjs_9546ModdingtoolsCode_9546GDmemoryObjects2Objects = Hashtable.newFrom({"memory": gdjs.ModdingtoolsCode.GDmemoryObjects2});
...
{
gdjs.copyArray(runtimeScene.getObjects("memory"), gdjs.ModdingtoolsCode.GDmemoryObjects2);
{for(var i = 0, len = gdjs.ModdingtoolsCode.GDmemoryObjects2.length ;i < len;++i) {
    gdjs.ModdingtoolsCode.GDmemoryObjects2[i].setString(gdjs.evtTools.common.toString(gdjs.evtTools.common.trunc(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("memory")))) + " MB");
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.ModdingtoolsCode.mapOfGDgdjs_9546ModdingtoolsCode_9546GDmemoryObjects2Objects, 3, 29, "notes / ui");
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.ModdingtoolsCode.mapOfGDgdjs_9546ModdingtoolsCode_9546GDmemoryObjects2Objects, 3, 29, "black");
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.ModdingtoolsCode.mapOfGDgdjs_9546ModdingtoolsCode_9546GDmemoryObjects2Objects, 3, 29, "");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.ModdingtoolsCode.mapOfGDgdjs_9546ModdingtoolsCode_9546GDfpsObjects2Objects, 3, 3, "");
}}
...
gdjs.copyArray(runtimeScene.getObjects("memory"), gdjs.ModdingtoolsCode.GDmemoryObjects2);
{for(var i = 0, len = gdjs.ModdingtoolsCode.GDmemoryObjects2.length ;i < len;++i) {
    gdjs.ModdingtoolsCode.GDmemoryObjects2[i].deleteFromScene(runtimeScene);
}
}}
...
{ //Subevents
gdjs.ModdingtoolsCode.eventsList1(runtimeScene);} //End of subevents
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.ModdingtoolsCode.GDmemoryObjects2.length;i<l;++i) {
    if ( gdjs.ModdingtoolsCode.GDmemoryObjects2[i].getString() == "0 MB" ) {
        isConditionTrue_0 = true;
        gdjs.ModdingtoolsCode.GDmemoryObjects2[k] = gdjs.ModdingtoolsCode.GDmemoryObjects2[i];
        ++k;
    }
}
gdjs.ModdingtoolsCode.GDmemoryObjects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
if (isConditionTrue_0) {
/* Reuse gdjs.ModdingtoolsCode.GDmemoryObjects2 */
{for(var i = 0, len = gdjs.ModdingtoolsCode.GDmemoryObjects2.length ;i < len;++i) {
    gdjs.ModdingtoolsCode.GDmemoryObjects2[i].setString("(   memory usage not supported   )");
}
}{for(var i = 0, len = gdjs.ModdingtoolsCode.GDmemoryObjects2.length ;i < len;++i) {
    gdjs.ModdingtoolsCode.GDmemoryObjects2[i].getBehavior("Tween").addObjectOpacityTween("fadeawakmemory", 0, "easeInQuad", 2000, true);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(58742676);
}
}
if (isConditionTrue_0) {
}
...
};gdjs.ModdingtoolsCode.asyncCallback57887356 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "gameengine2.022", false);
}}
gdjs.ModdingtoolsCode.eventsList10 = function(runtimeScene) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(5), (runtimeScene) => (gdjs.ModdingtoolsCode.asyncCallback57887356(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.ModdingtoolsCode.eventsList11 = function(runtimeScene) {
...
gdjs.ModdingtoolsCode.eventsList4(runtimeScene);
}
...
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "modedit.charteditor", true);
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "modeedit.chatectededitor", true);
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "modeedit.sceneeditor", true);
}}
...
if (isConditionTrue_0) {
{runtimeScene.getGame().getVariables().getFromIndex(9).getChild("from").setString("charteditor");
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(57887284);
}
}
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.ModdingtoolsCode.eventsList10(runtimeScene);} //End of subevents
}
...
gdjs.ModdingtoolsCode.eventsList11(runtimeScene);
